...
' > etc/voxforge_it_sphinx.transcription
./traintest.sh etc/voxforge_it_sphinx.transcription
./build_fileids.py etc/voxforge_it_sphinx.transcription.train > etc/voxforge_it_sphinx.fileids.train
./build_fileids.py etc/voxforge_it_sphinx.transcription.test > etc/voxforge_it_sphinx.fileids.test
}
